...
param_str <- sprintf("thr%s_prev%s_%s",inp_threshold,inp_prevalence,sample_flag)
...
```
Testing updated prevotella filtering function
```{r}
get_prevotella_filtered_gene_vec <- function(tpm.df, inp_threshold, inp_prevalence,CECAL_ONLY=FALSE) {
    #' @param tpm.df locus rows x sample columns
    #' @param inp_threshold threshold of tpm
...
test_prev_filtered <- get_prevotella_filtered_gene_vec(tpm.df,inp_threshold,inp_prevalence,CECAL_ONLY =TRUE)
```
